...
export const DEFAULT_SITE_IMAGES: Record<string, DefaultSiteImageMeta> = {
  ...
  app_solar_ess: {
    ...
    section: 'applications',
    defaultUrl: '/assets/applications/app-solar-ess.jpg',
  ...
  app_ups_inverter: {
    ...
    section: 'applications',
    defaultUrl: '/assets/applications/app-ups-inverter.jpg',
  ...
  app_industrial_equipment: {
    ...
    section: 'applications',
    defaultUrl: '/assets/applications/app-material-handling.jpg',
  ...
  app_robotics_automation: {
    ...
    section: 'applications',
    defaultUrl: '/assets/applications/app-robotics-automation.jpg',
  ...
  app_drones_uav: {
    ...
    section: 'applications',
    defaultUrl: '/assets/applications/app-drones-uav.jpg',
  ...
  app_telecom_infrastructure: {
    ...
    section: 'applications',
    defaultUrl: '/assets/applications/app-telecom-infrastructure.jpg',
